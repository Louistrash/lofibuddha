...
export const MEDITATIONS: Meditation[] = [
...

  {
    ...
    introPause: 10,
    segments: [
      { text: "Come into stillness, and place a hand over your heart, letting it rest there. This practice is a way of speaking to yourself with the same tenderness you offer the people you love. There is nothing to fix, and nothing to become. Just soften, and listen.", pauseAfter: 6 },
      { text: "Repeat these words silently, and let them land where they are needed most. I am worthy of love, exactly as I am. Not when I improve, not when I achieve. Right now, in this moment, I am enough.", pauseAfter: 6 },
      { text: "I am allowed to be a work in progress. I do not have to have it all figured out. Every version of me — the struggling one, the tired one, the growing one — deserves my kindness.", pauseAfter: 6 },
      { text: "I release the habit of being harsh with myself. I let go of the inner voice that criticizes and compares. In its place, I plant a gentler voice, one that says: you are doing better than you think.", pauseAfter: 6 },
      { text: "I am not defined by my mistakes. They are lessons, not a verdict. I have grown through every difficulty, and I will continue to grow, with patience and grace.", pauseAfter: 6 },
      { text: "My worth is not something I earn. It is something I already am. The sun does not prove it deserves to shine, and neither do I. I simply am, and that is enough.", pauseAfter: 6 },
      { text: "I give myself permission to rest, to receive, to be held. I do not have to carry everything alone. Asking for support is not weakness; it is wisdom.", pauseAfter: 6 },
      { text: "I forgive myself for the times I did not know better. I was doing my best with what I knew then. Now I know more, and I choose gentleness.", pauseAfter: 7 },
      { text: "I am not in competition with anyone, including the person I used to be. I am simply becoming, and becoming is enough.", pauseAfter: 7 },
      { text: "I honor my own needs and boundaries. Saying no to others so I can say yes to myself is an act of love, not selfishness.", pauseAfter: 7 },
      { text: "I am learning to see myself through kind eyes. Not through the eyes of my critics, or my fears, but through the eyes of the part of me that has always loved me.", pauseAfter: 7 },
      { text: "As this practice closes, let the warmth stay with you. I am my own friend. I am my own home. I will carry this gentleness with me, into the hours ahead.", pauseAfter: 8 },
    ],
  },
  {
    id: "affirm-trust",
    ...
    introPause: 10,
    segments: [
      { text: "Settle into stillness, and let the day fall behind you. This practice is about trust — trust in yourself, in the timing of your life, in the quiet wisdom that moves beneath everything.", pauseAfter: 6 },
      { text: "Repeat softly. I trust myself. I trust my choices, my timing, my ability to find my way. Even when the path is unclear, something in me knows the next step.", pauseAfter: 6 },
      { text: "I trust the process of my life. Not everything that is meant for me arrives on my schedule. Some things are ripening, quietly, out of sight. I let them unfold in their own time.", pauseAfter: 6 },
      { text: "I release the need to control every outcome. I do what is mine to do, and I let the rest go. What is meant for me will not miss me, and what is not meant for me was never mine to keep.", pauseAfter: 6 },
      { text: "I am safe in uncertainty. I do not need to see the whole staircase to take the first step. The next step is enough, and it always appears when I need it.", pauseAfter: 6 },
      { text: "I trust my body, my breath, my intuition. They have carried me through every hard thing so far, and they will carry me through this too.", pauseAfter: 6 },
      { text: "I let go of fear and choose faith — not blind faith, but a quiet confidence that life is working with me, not against me.", pauseAfter: 6 },
      { text: "I trust that I can handle what comes. I have survived everything I have faced so far, and I am still here, still growing.", pauseAfter: 7 },
      { text: "I trust the quiet voice inside me more than the loud voice of doubt. My intuition is wise, and it has never abandoned me.", pauseAfter: 7 },
      { text: "I let go of the need to know how everything will work out. The how is not mine to control. The next step is mine, and that is enough.", pauseAfter: 7 },
      { text: "I trust that I am exactly where I need to be, learning exactly what I need to learn. Nothing is wasted, and nothing is behind schedule.", pauseAfter: 7 },
      { text: "As I close, I breathe in trust and breathe out doubt. I am held. I am guided. I can relax into the unfolding of my own life.", pauseAfter: 8 },
    ],
  },
  {
    id: "affirm-abundance",
    ...
    introPause: 10,
    segments: [
      { text: "Come to stillness, and open your hands, palms upward, as if to receive. This practice is about abundance — not just of money, but of love, time, energy, and possibility. Abundance is a way of seeing.", pauseAfter: 6 },
      { text: "Repeat softly. I am open to receiving. Good things are allowed to come to me. I do not have to struggle for every blessing; some of them are simply gifts.", pauseAfter: 6 },
      { text: "There is enough. Enough time, enough love, enough opportunity. The universe is generous, and I am part of its generosity. Scarcity is a story I am ready to set down.", pauseAfter: 6 },
      { text: "I release the belief that I must be small to be safe. I can grow, expand, and take up space. My rising does not take anything from anyone else.", pauseAfter: 6 },
      { text: "I am grateful for what I already have, and I remain open to more. Gratitude and openness are the two hands of abundance — one holds, the other receives.", pauseAfter: 6 },
      { text: "I deserve prosperity in all its forms: rest, joy, connection, and provision. Abundance is not a reward for being perfect; it is my natural inheritance.", pauseAfter: 6 },
      { text: "I give freely, and I receive freely. The flow of giving and receiving keeps abundance moving through my life. I am a channel, not a dam.", pauseAfter: 6 },
      { text: "I celebrate the good in my life, and I allow myself to want more. Wanting more is not greed; it is the natural movement of a life that is growing.", pauseAfter: 7 },
      { text: "I release scarcity from my body and my mind. I breathe in the truth that I am supported, and I breathe out the fear that there will not be enough.", pauseAfter: 7 },
      { text: "I am worthy of wealth in all its forms — love, health, joy, and provision. My worth is not measured by what I have, but what I have is allowed to grow.", pauseAfter: 7 },
      { text: "I open myself to unexpected good. Miracles, small and large, are not rare; they are simply waiting for me to notice and receive them.", pauseAfter: 7 },
      { text: "As I close, I breathe in possibility and breathe out lack. I am abundant. I am supported. I am ready to receive all the good that is meant for me.", pauseAfter: 8 },
    ],
  },
];
