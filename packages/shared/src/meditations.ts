...
export const MEDITATIONS: Meditation[] = [
...

  {
    ...
    introPause: 10,
    segments: [
      { text: "Come into stillness, and place a hand over your heart, letting it rest there. This practice is a way of speaking to yourself with the same tenderness you offer the people you love. There is nothing to fix, and nothing to become. Just soften, and listen.", pauseAfter: 10 },
      { text: "Repeat these words silently, and let them land where they are needed most. I am worthy of love, exactly as I am. Not when I improve, not when I achieve. Right now, in this moment, I am enough.", pauseAfter: 10 },
      { text: "I am allowed to be a work in progress. I do not have to have it all figured out. Every version of me — the struggling one, the tired one, the growing one — deserves my kindness.", pauseAfter: 10 },
      { text: "I release the habit of being harsh with myself. I let go of the inner voice that criticizes and compares. In its place, I plant a gentler voice, one that says: you are doing better than you think.", pauseAfter: 10 },
      { text: "I am not defined by my mistakes. They are lessons, not a verdict. I have grown through every difficulty, and I will continue to grow, with patience and grace.", pauseAfter: 10 },
      { text: "My worth is not something I earn. It is something I already am. The sun does not prove it deserves to shine, and neither do I. I simply am, and that is enough.", pauseAfter: 10 },
      { text: "I give myself permission to rest, to receive, to be held. I do not have to carry everything alone. Asking for support is not weakness; it is wisdom.", pauseAfter: 10 },
      { text: "I forgive myself for the times I did not know better. I was doing my best with what I knew then. Now I know more, and I choose gentleness.", pauseAfter: 10 },
      { text: "I am not in competition with anyone, including the person I used to be. I am simply becoming, and becoming is enough.", pauseAfter: 10 },
      { text: "I honor my own needs and boundaries. Saying no to others so I can say yes to myself is an act of love, not selfishness.", pauseAfter: 10 },
      { text: "I am learning to see myself through kind eyes. Not through the eyes of my critics, or my fears, but through the eyes of the part of me that has always loved me.", pauseAfter: 10 },
      { text: "As this practice closes, let the warmth stay with you. I am my own friend. I am my own home. I will carry this gentleness with me, into the hours ahead.", pauseAfter: 10 },
    ],
  },
  {
    id: "affirm-trust",
    ...
    introPause: 10,
    segments: [
      { text: "Settle into stillness, and let the day fall behind you. This practice is about trust — trust in yourself, in the timing of your life, in the quiet wisdom that moves beneath everything.", pauseAfter: 10 },
      { text: "Repeat softly. I trust myself. I trust my choices, my timing, my ability to find my way. Even when the path is unclear, something in me knows the next step.", pauseAfter: 10 },
      { text: "I trust the process of my life. Not everything that is meant for me arrives on my schedule. Some things are ripening, quietly, out of sight. I let them unfold in their own time.", pauseAfter: 10 },
      { text: "I release the need to control every outcome. I do what is mine to do, and I let the rest go. What is meant for me will not miss me, and what is not meant for me was never mine to keep.", pauseAfter: 10 },
      { text: "I am safe in uncertainty. I do not need to see the whole staircase to take the first step. The next step is enough, and it always appears when I need it.", pauseAfter: 10 },
      { text: "I trust my body, my breath, my intuition. They have carried me through every hard thing so far, and they will carry me through this too.", pauseAfter: 10 },
      { text: "I let go of fear and choose faith — not blind faith, but a quiet confidence that life is working with me, not against me.", pauseAfter: 10 },
      { text: "I trust that I can handle what comes. I have survived everything I have faced so far, and I am still here, still growing.", pauseAfter: 10 },
      { text: "I trust the quiet voice inside me more than the loud voice of doubt. My intuition is wise, and it has never abandoned me.", pauseAfter: 10 },
      { text: "I let go of the need to know how everything will work out. The how is not mine to control. The next step is mine, and that is enough.", pauseAfter: 10 },
      { text: "I trust that I am exactly where I need to be, learning exactly what I need to learn. Nothing is wasted, and nothing is behind schedule.", pauseAfter: 10 },
      { text: "As I close, I breathe in trust and breathe out doubt. I am held. I am guided. I can relax into the unfolding of my own life.", pauseAfter: 10 },
    ],
  },
  {
    id: "affirm-abundance",
    ...
    introPause: 10,
    segments: [
      { text: "Come to stillness, and open your hands, palms upward, as if to receive. This practice is about abundance — not just of money, but of love, time, energy, and possibility. Abundance is a way of seeing.", pauseAfter: 10 },
      { text: "Repeat softly. I am open to receiving. Good things are allowed to come to me. I do not have to struggle for every blessing; some of them are simply gifts.", pauseAfter: 10 },
      { text: "There is enough. Enough time, enough love, enough opportunity. The universe is generous, and I am part of its generosity. Scarcity is a story I am ready to set down.", pauseAfter: 10 },
      { text: "I release the belief that I must be small to be safe. I can grow, expand, and take up space. My rising does not take anything from anyone else.", pauseAfter: 10 },
      { text: "I am grateful for what I already have, and I remain open to more. Gratitude and openness are the two hands of abundance — one holds, the other receives.", pauseAfter: 10 },
      { text: "I deserve prosperity in all its forms: rest, joy, connection, and provision. Abundance is not a reward for being perfect; it is my natural inheritance.", pauseAfter: 10 },
      { text: "I give freely, and I receive freely. The flow of giving and receiving keeps abundance moving through my life. I am a channel, not a dam.", pauseAfter: 10 },
      { text: "I celebrate the good in my life, and I allow myself to want more. Wanting more is not greed; it is the natural movement of a life that is growing.", pauseAfter: 10 },
      { text: "I release scarcity from my body and my mind. I breathe in the truth that I am supported, and I breathe out the fear that there will not be enough.", pauseAfter: 10 },
      { text: "I am worthy of wealth in all its forms — love, health, joy, and provision. My worth is not measured by what I have, but what I have is allowed to grow.", pauseAfter: 10 },
      { text: "I open myself to unexpected good. Miracles, small and large, are not rare; they are simply waiting for me to notice and receive them.", pauseAfter: 10 },
      { text: "As I close, I breathe in possibility and breathe out lack. I am abundant. I am supported. I am ready to receive all the good that is meant for me.", pauseAfter: 10 },
    ],
  },
...

  {
    ...
    introPause: 15,
    segments: [
      { text: "Come into a comfortable seat, and let your body settle. This is a longer practice — a slow return to the simple truth that you are enough, exactly as you are. There is nowhere to rush, and nothing to prove. Just breathe, and arrive.", pauseAfter: 20 },
      { text: "In the quiet of this moment, notice the voice that says you are not enough. Notice it, without believing it. That voice is not the truth. It is only an old habit, learned long ago.", pauseAfter: 20 },
      { text: "Now, gently, place a hand on your heart. Feel its steady rhythm. This heart has kept you alive through everything. It has never once asked you to be more than you are.", pauseAfter: 20 },
      { text: "Repeat softly: I am enough. Not when I achieve more. Not when I fix my flaws. Not when others approve of me. I am enough, right now, in this moment.", pauseAfter: 20 },
      { text: "I am enough in my quiet, ordinary moments. In my tiredness. In my uncertainty. My worth does not rise and fall with my productivity. It simply is.", pauseAfter: 20 },
      { text: "I release the exhausting need to prove my value. I have spent so long trying to earn my place. But my place was never something to earn. It was always mine.", pauseAfter: 20 },
      { text: "I am enough for the people who love me. And even when I feel unseen, I am still enough. Being seen and being worthy are not the same thing.", pauseAfter: 20 },
      { text: "I let go of comparison. Another person's light does not dim mine. There is room for all of us, and my path is not a race against anyone.", pauseAfter: 20 },
      { text: "I am enough in my growth, and I am enough in my struggle. The version of me who is still learning deserves as much kindness as the version who has arrived.", pauseAfter: 20 },
      { text: "I forgive myself for the days I did not show up as my best self. I was still there. I was still trying. And that was enough.", pauseAfter: 20 },
      { text: "I am not a problem to be solved. I am a person to be lived. My existence is not a flaw waiting to be corrected. It is a gift, unfolding.", pauseAfter: 20 },
      { text: "Repeat again, and let it sink deeper: I am enough. With my scars. With my story. With my fears and my hopes. All of me is welcome here.", pauseAfter: 20 },
      { text: "I trust that I am held by something larger than my own effort. I do not have to hold myself together alone. The earth is beneath me, and the sky is above me, and I am enough.", pauseAfter: 20 },
      { text: "I am enough in my rest. I am enough in my silence. I do not have to fill every moment with doing. Simply being is a kind of wholeness.", pauseAfter: 20 },
      { text: "As this practice deepens, let the truth settle into your bones: you have always been enough. The search was never for your worth. It was only for the courage to believe it.", pauseAfter: 20 },
      { text: "Slowly, gently, bring your awareness back. Carry this knowing with you: I am enough. Not someday. Not when. Now. And that is the deepest truth you will ever need.", pauseAfter: 8 },
    ],
  },
  {
    ...
    introPause: 15,
    segments: [
      { text: "Settle into stillness, and let your eyes close softly. This is a longer practice — a slow descent into the peace that already lives beneath the noise. There is nothing to fix, and nowhere to be. Just rest here.", pauseAfter: 20 },
      { text: "Notice the tension you are carrying. In your shoulders, your jaw, your belly. You do not need to force it away. Just notice it, and let it be held.", pauseAfter: 20 },
      { text: "Repeat softly: I am at peace. Not because everything in my life is perfect, but because I am learning to rest in what is.", pauseAfter: 20 },
      { text: "I release the war with this moment. I stop fighting what is already here. Peace is not the absence of difficulty. It is the space I create around it.", pauseAfter: 20 },
      { text: "I am at peace with my past. It has shaped me, but it does not own me. I can look back without being pulled back.", pauseAfter: 20 },
      { text: "I am at peace with my future. I do not know what it holds, and I do not need to. I can meet it with an open heart, one moment at a time.", pauseAfter: 20 },
      { text: "I am at peace with my body. It has carried me this far. I release the criticism and greet it with gratitude for all it has done.", pauseAfter: 20 },
      { text: "I am at peace with my mind. My thoughts are visitors, not residents. I can watch them come and go without becoming them.", pauseAfter: 20 },
      { text: "I am at peace with other people. I cannot control how they see me or what they do. I can only choose how I respond, and I choose calm.", pauseAfter: 20 },
      { text: "I release the need to be right, the need to be understood, the need to be everywhere at once. I am allowed to be here, simply, fully.", pauseAfter: 20 },
      { text: "Repeat again: I am at peace. Let the words become a doorway, not a demand. You are not forcing peace. You are remembering it.", pauseAfter: 20 },
      { text: "In the silence between these words, feel the stillness that was always here. It was never gone. It was only covered by the noise.", pauseAfter: 20 },
      { text: "I am at peace with my own pace. I do not have to rush. The tree does not hurry to grow, and neither must I.", pauseAfter: 20 },
      { text: "I am at peace with not knowing. Not everything needs an answer. Some things are meant to be lived, not understood.", pauseAfter: 20 },
      { text: "As this practice deepens, let go of the last of the day's weight. Peace is not something you find. It is something you stop running from.", pauseAfter: 20 },
      { text: "Slowly, gently, return. Carry this peace with you, like a quiet current beneath everything you do. I am at peace. And that peace is always here, waiting.", pauseAfter: 8 },
    ],
  },
];
