...
export const EXPERIENCES: Experience[] = [
...

  {
    ...
    description: "Speak to yourself with the tenderness you offer others — a gentle practice of self-acceptance.",
    duration: "4 min",
    guide: "affirm-self-love",
    soundscape: "off",
    music: "temple-rain",
    scene: "ocean",
    accent: "#A855F7",
  ...
  },
  {
    id: "affirm-trust",
    category: "relax",
    title: "Trust Affirmations",
    description: "Soften into trust — in yourself, in your timing, in the quiet wisdom moving beneath everything.",
    duration: "4 min",
    guide: "affirm-trust",
    soundscape: "off",
  ...
  },
  {
    ...
    description: "Open your hands and your heart — abundance of love, time, and possibility is already yours.",
    duration: "4 min",
    guide: "affirm-abundance",
    soundscape: "off",
    music: "stone-bowl-garden",
    scene: "ocean",
    accent: "#A855F7",
    premium: true,
  },
