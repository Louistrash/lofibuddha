...
export const SOUNDS: Sound[] = [
  ...
  { slug: "night-forest", name: "Night Forest", description: "Crickets and a soft nighttime atmosphere.", category: "Nature", prompt: "Night forest, clean gentle crickets, soft nocturnal atmosphere, clear and quiet, no music, calm" },
...
export const MODES: Mode[] = [
  ...
  },
  {
    ...
    mix: { "ocean-waves": 0.55, "night-forest": 0.3, "fireplace": 0.2 },
  },
];
