...
import { ArrowRight, Check, Clock, Heart, BookOpen, Music, ChevronRight, Moon } from "lucide-react";
    ...
    <div className="min-h-screen" style={{ background: "#faf8f5", color: "#1c1917", fontFamily: '"Inter", system-ui, sans-serif' }}>
      ...
      >
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link
            href="/landing"
            style={{ color: "#78716c", fontSize: "0.8rem", letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}
          >
            ← Home
          </Link>
        </div>
      ...
      <main className="max-w-2xl mx-auto px-6 py-12 sm:py-16">
        ...
        <div className="text-center mb-10">
          <p style={{ fontSize: "0.65rem", textTransform: "uppercase", letterSpacing: "0.3em", color: "#b08050", marginBottom: "0.75rem" }}>
            Your Journey
          </p>
          <h1 style={{ fontFamily: '"Playfair Display", serif', fontSize: "clamp(1.8rem, 4vw, 2.5rem)", fontWeight: 300 }}>
            Welcome back
          </h1>
          <p style={{ color: "#78716c", marginTop: "0.75rem", fontWeight: 300 }}>
            Enter your email to see your practice journey.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            >
              <p style={{ fontSize: "0.7rem", textTransform: "uppercase", letterSpacing: "0.2em", color: "#b08050", marginBottom: "0.5rem" }}>
                {drip.tier === "enlightened" ? "Enlightened Path" : drip.tier === "mindful" ? "Mindful Path" : "Zen Beginner"}
              </p>
              <p style={{ fontSize: "2.5rem", fontFamily: '"Playfair Display", serif', fontWeight: 300, color: "#1c1917" }}>
                Day {drip.dripDay}
              </p>
              {startDateStr && (
                <p style={{ color: "#78716c", fontSize: "0.85rem", fontWeight: 300 }}>
                  Your journey began {startDateStr}
                </p>
              )}
            </div>
            ...
            {/* Unlocked items */}
            <div>
              <h2 style={{ fontFamily: '"Playfair Display", serif', fontSize: "1.3rem", fontWeight: 500, marginBottom: "1rem" }}>
                Unlocked so far
              </h2>
              <div className="space-y-3">
                {drip.unlocked.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p style={{ fontWeight: 400, color: "#1c1917", fontSize: "0.9rem" }}>{item.label}</p>
            ...
            {drip.nextUnlock && (
              <div
                ...
                style={{ background: "#f5f0e8", border: "1px dashed rgba(0,0,0,0.08)" }}
              >
                <div className="flex items-center justify-center gap-2 mb-1">
                  <Clock size={14} style={{ color: "#b08050" }} />
                  <p style={{ fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.15em", color: "#b08050" }}>
                    Next unlock — Day {drip.nextUnlock.day}
                  </p>
                </div>
                <p style={{ fontFamily: '"Playfair Display", serif', fontSize: "1.1rem", color: "#1c1917", fontWeight: 400 }}>
                  {drip.nextUnlock.label}
                </p>
                <p style={{ color: "#78716c", fontSize: "0.8rem", fontWeight: 300, marginTop: "0.25rem" }}>
                  {drip.nextUnlock.day - drip.dripDay} day{drip.nextUnlock.day - drip.dripDay > 1 ? "s" : ""} to go
                </p>
              </div>
            )}
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-4">
              ...
              <Link
                ...
                style={{
                  display: "inline-flex", alignItems: "center", gap: "0.5rem",
                  padding: "0.7rem 1.5rem", borderRadius: "100px",
                  border: "1px solid rgba(0,0,0,0.1)", color: "#1c1917", textDecoration: "none",
                  fontSize: "0.8rem", fontFamily: '"Inter", sans-serif',
                }}
              >
                <Music size={14} />
